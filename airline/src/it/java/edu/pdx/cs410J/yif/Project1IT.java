...
class Project1IT extends InvokeMainTestCase {
    ...
    void testDiffAirline(){
        MainMethodResult result = invokeMain("-textFile", "src/test/resources/edu/pdx/cs410J/yif/diffNameTest.txt", "Test2", "2", "src", "10/19/2022", "0:0", "des", "1/20/2022", "12:30");
        assertThat(result.getExitCode(), equalTo(1));
    ...
    void testIncompleteFlightParse(){
        MainMethodResult result = invokeMain("-textFile", "src/test/resources/edu/pdx/cs410J/yif/incompleteFlightTest.txt", "Test3", "2", "src", "10/19/2022", "0:0", "des", "1/20/2022", "12:30");
        assertThat(result.getExitCode(), equalTo(1));
    }
    ...
    void testMalformattedFlight(){
        MainMethodResult result = invokeMain("-textFile", "src/test/resources/edu/pdx/cs410J/yif/malformattedFlightTest.txt", "Test4", "2", "src", "10/19/2022", "0:0", "des", "1/20/2022", "12:30");
        assertThat(result.getExitCode(), equalTo(1));
    }
    ...
    void testTextFileCorrect(){
        MainMethodResult result = invokeMain("-textFile", "src/test/resources/edu/pdx/cs410J/yif/textFileTest.txt", "Test5", "40", "src", "10/19/2022", "0:0", "des", "1/20/2022", "12:30");
        assertThat(result.getExitCode(), equalTo(0));
    }
}